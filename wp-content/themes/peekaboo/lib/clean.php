...
if( ! function_exists( 'peekaboo_rss_version ' ) ) {
	function peekaboo_rss_version() { return ''; }
}
...
if( ! function_exists( 'peekaboo_scripts_and_styles ' ) ) {
	function peekaboo_scripts_and_styles() {
	  if (!is_admin()) {
	    ...
	    wp_register_script( 'foundation-js', get_template_directory_uri() . '/bower_components/foundation/js/foundation.js', array( 'jquery' ), '', true );
        ...
        // theme script
        wp_register_script('custom', get_template_directory_uri() . '/js/init.js', 'jquery', null, true);

        // flexslider
        wp_register_script('slider', get_template_directory_uri() . '/bower_components/flexslider/jquery.flexslider-min.js', array('jquery'), '', true);

        // enqueue styles and scripts
	    wp_enqueue_script( 'peekaboo-modernizr' );
        ...
        // Isotope scripts
        wp_register_script('isotope', get_template_directory_uri() . '/bower_components/isotope/jquery.isotope.min.js', array('jquery'), '', true);
        if (is_page_template('page-gallery.php') || is_page_template('page-gallery-2-col-demo.php') || is_page_template('page-gallery-4-col-demo.php')) {
