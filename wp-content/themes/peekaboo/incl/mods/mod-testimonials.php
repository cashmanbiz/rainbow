    ...
    <div class="row section-title">
        <div class="columns large-10">
            <?php if ($smof_data['pkb_testimonial_mod_url']) { ?>
                <h4 class="replace"><a
                        href="?p=<?php echo stripslashes($smof_data['pkb_testimonial_mod_url']); ?>"><?php echo stripslashes($smof_data['pkb_testimonial_mod_title']); ?></a>
                </h4>
            <?php } else { ?>
        ...
        <?php if ($smof_data['pkb_testimonial_mod_more_link']) { ?>
            <div class="columns large-2 hide-for-small">
                <a href="?p=<?php echo stripslashes($smof_data['pkb_testimonial_mod_url']); ?>"
