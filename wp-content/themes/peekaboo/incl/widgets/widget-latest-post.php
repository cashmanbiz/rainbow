...
class pkb_widget_latest_post extends WP_Widget
{
    ...
    function pkb_widget_latest_post()
    {
        ...
        $this->WP_Widget('pkb_widget_latest_post', __('Peekaboo Latest Posts', 'peekaboo'), $widget_ops);
...
//	Outputs the options form on admin
    ...
    function form($instance)
    {
        ...
        <p>
            <label for="<?php echo $this->get_field_id('cat'); ?>"><?php _e('Category ID:', 'peekaboo') ?></label>
            <input class="widefat" id="<?php echo $this->get_field_id('cat'); ?>"
                   name="<?php echo $this->get_field_name('cat'); ?>" value="<?php echo $instance['cat']; ?>"
                   type="text"/>
        </p>
